...
local function TakeOutVehicle(vehicleInfo, playerId)
    ...
    if coords then
        ...
        QBCore.Functions.SpawnVehicle(vehicleInfo.vehicle, function(veh)
            ...
            TriggerServerEvent("td-aracver:server:sendVehicle", vehicleInfo.vehicle, GetHashKey(vehicleInfo.vehicle), QBCore.Functions.GetPlate(veh), QBCore.Functions.GetVehicleProperties(veh))
